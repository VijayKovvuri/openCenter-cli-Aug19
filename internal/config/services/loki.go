...
type LokiConfig struct {
	...
	// Storage
	StorageType  string `yaml:"storage_type,omitempty" json:"storage_type,omitempty" jsonschema:"description=Loki storage backend type,enum=s3,enum=swift,enum=none,default=swift"`
