...
type VeleroConfig struct {
	...
	StorageType      string `yaml:"storage_type,omitempty" json:"storage_type,omitempty" jsonschema:"description=Velero storage backend type,enum=s3,enum=swift,enum=gcs,enum=azure,enum=none,default=s3"`
}
