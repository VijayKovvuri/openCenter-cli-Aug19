...
- **Getting Started:** [First cluster walkthrough](docs/getting-started/getting-started.md), plus dedicated guides for [Kind](docs/getting-started/kind-local-development.md), [OpenStack](docs/getting-started/openstack-first-cluster.md), [VMware](docs/getting-started/vmware-deployment.md), and [multi-cluster setups](docs/getting-started/multi-cluster-setup.md).
